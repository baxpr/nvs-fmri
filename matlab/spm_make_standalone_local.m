function spm_make_standalone_local(spmdir,outdir,extradir1,extradir2,extradir3)
...
try
    ...
    compiler.build.standaloneApplication( ...
        which('spm_standalone.m'), ...
        'Verbose', true, ...
        'OutputDir', outdir, ...
        'ExecutableName', lower(spm('Ver')), ...
        'EmbedArchive', false, ...
        'AdditionalFiles', {spm('Dir'),extradir1,extradir2,extradir3} ...
        )
    ...
    for i = 1:numel(ME.cause)
        fprintf('\n--- CAUSE %d ---\n', i);
        disp(getReport(ME.cause{i},'extended','hyperlinks','on'));
    end
